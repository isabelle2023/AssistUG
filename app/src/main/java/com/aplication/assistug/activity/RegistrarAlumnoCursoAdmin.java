...
public class RegistrarAlumnoCursoAdmin extends AppCompatActivity {
    ...
    Button btnBuscarAlumnRAC, btnRegistrarAlumnRAC, BtExcel, BtExit;
    ImageButton btbackRAC;
    String uidcurso, uidalumno, nombrecurso;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registrar_alumno_curso_admin);
        ...
        filePicker = registerForActivityResult(
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        ReadExcelFile(RegistrarAlumnoCursoAdmin.this
                                , uri);
                ...
                mDatabase.orderByChild("cedula").equalTo(cedulaa).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            Toast.makeText(RegistrarAlumnoCursoAdmin.this, "El alumno no esta registrado.", Toast.LENGTH_SHORT).show();
    ...
    void Toast(String message, Exception ex) {
        ...
        Toast.makeText(RegistrarAlumnoCursoAdmin.this, message, Toast.LENGTH_LONG).show();
    ...
    private void requestStoragePermission() {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(RegistrarAlumnoCursoAdmin.this,
